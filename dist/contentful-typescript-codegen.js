...
function renderContentTypeFields(fields, localization) {
    return fields
        ...
        var functionMap = (_a = {
            ...
            _a["ResourceLink"] = renderLink,
            _a.Location = renderLocation,
            _a.Number = renderNumber,
            _a.Object = renderObject,
            _a.RichText = renderRichText,
            _a.Symbol = renderSymbol,
            _a.Text = renderSymbol,
            _a);
...
function renderContentTypeFields$1(fields) {
    return fields
        ...
        var functionMap = (_a = {
            ...
            _a["ResourceLink"] = renderLink$1,
            _a.Location = renderLocation,
            _a.Number = renderNumber,
            _a.Object = renderObject,
            _a.RichText = renderRichText$1,
            _a.Symbol = renderSymbol,
            _a.Text = renderSymbol,
            _a);
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    outputPath = path__default.resolve(process.cwd(), outputFile);
